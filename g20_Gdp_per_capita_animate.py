...
def create_gdp_animation(df_animated):
    ...
    def animate(year):
        ...
        for bar in bars:
            ...
            ax.text(
                ...
                yval + 500,  # Add 500 to position text above bar
    ...
    ani = FuncAnimation(
        fig, animate, frames=animation_years, interval=200, repeat=False
    )
    ...
    try:
        ...
        print(
            "Please install FFmpeg on your system to save the animation as an MP4 video."
        )
