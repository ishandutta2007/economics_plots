...
def plot_comparison():
    ...
    ax1.plot(years, us_wages, label='USA (Average Wage Index)', marker='o', linestyle='-', color='blue')
    ...
    ax2.plot(years, india_gdp_per_capita, label='India (GDP per Capita)', marker='s', linestyle='--', color='green')
