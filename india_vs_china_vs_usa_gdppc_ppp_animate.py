...
df = wb.download(indicator=indicator, country=countries, start=1990, end=2023)
...
ax1.set_title(
    "GDP per capita(PPP): USA vs China vs India (1990-2023)",
    fontsize=19,
    fontweight="bold",
)
...
ani.save("india_vs_usa_china_gdp_pc_ppp_comparison.mp4", writer=writer)
