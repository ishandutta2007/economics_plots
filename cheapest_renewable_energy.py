...
prices = [
    0.049, 0.033, 0.0709, 0.085, 0.060, 0.062,
    0.057, 0.037, 0.086, 0.077
]
...
colors = ['seagreen' if i not in western_indices else 'orange' for i in range(len(countries))]

# Create the plot
plt.figure(figsize=(12, 7))
bars = plt.barh(countries, prices, color=colors)
plt.xlabel("LCOE (USD per kWh)")
plt.title("Renewable Energy Costs by Country (2023)\nWestern Countries Highlighted in Orange")
