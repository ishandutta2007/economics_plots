...
data = {
    ...
    'OTHERS':         [12,  12,   11,   9,    9,    8,    7,    5,    4,    4,    4,    4,    4,    4,    5,    5,    5,    6,    7],
    'FRANCE':         [3,   3,    4,    4,    5,    5,    6,    7,    6,    5,    3,    4,    4,    4,    4,    3,    3,    3,    2],
    'UNITED KINGDOM': [1,   2,    2,    3,    4,    6,    9,   12,   11,   10,    7,    7,    6,    6,    3,    2,    2,    2,    2],
    'SPAIN':          [3,   2,    3,    3,    4,    4,    6,    6,    6,    4,    2,    2,    2,    3,    2,    1,    1,    1,    1],
    'ITALY':          [4,   4,    5,    6,    6,    6,    6,    6,    6,    4,    3,    4,    3,    3,    2,    2,    2,    1,    1],
    'GERMANY':        [2,   2,    3,    3,    4,    4,    7,    7,    8,    10,   9,    5,    6,    7,    9,    8,    4,    3,    3],
    'RUSSIA':         [3,   3,    2,    2,    2,    2,    5,    7,    9,    10,   12,   15,   14,   14,   13,   11,    3,    3,    3],
    'JAPAN':          [1,   2,    3,    4,    5,    6,    5,    2,    3,    4,    6,    4,    7,    9,    10,   13,    8,    7,    6],
    'INDIA':          [40,  37,   32,   28,   28,   18,   16,   16,   14,   12,   12,   8,    7,    6,    6,    6,    6,    7,    8],
    'CHINA':          [30,  33,   34,   37,   32,   40,   30,   24,   16,   15,   14,   7,    8,    8,    7,    7,    11,  17,    18],
