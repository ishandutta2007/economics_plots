...
data = {
    ...
    'OTHERS':         [12,  12,   11,   9,    9,    8,    2,    2,    2,    2,    2,    2,    3,    4,    5,    5,    5,    5,    6],
    'FRANCE':         [3,   3,    4,    4,    5,    5,    4,    4,    4,    5,    3,    5,    4,    4,    3,    3,    3,    3,    2],
    'UNITED KINGDOM': [1,   2,    2,    3,    4,    6,    9,    12,   11,   10,   7,    6,    5,    4,    3,    2,    2,    2,    2],
    'SPAIN':          [3,   2,    3,    3,    4,    4,    2,    2,    2,    2,    1,    1,    1,    1,    1,    1,    1,    1,    1],
    'ITALY':          [4,   4,    5,    6,    6,    6,    3,    3,    3,    3,    3,    2,    2,    2,    2,    2,    2,    1,    1],
    'GERMANY':        [2,   2,    3,    3,    4,    4,    6,    7,    8,    11,   8,    4,    4,    4,    4,    4,    4,    3,    3],
    'RUSSIA':         [3,   3,    2,    2,    2,    2,    6,    6,    8,    9,    7,    4,    4,    4,    4,    4,    3,    3,    3],
    'JAPAN':          [1,   2,    3,    4,    5,    6,    3,    2,    4,    4,    5,    3,    4,    6,    7,    8,    8,    7,    6],
