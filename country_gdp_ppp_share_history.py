...
data = {
    ...
    'OTHERS':         [12,  12,   11,   9,    9,    8,    7,    2,    2,    2,    2,    2,    3,    4,    5,    5,    5,    5,    6],
    'FRANCE':         [3,   3,    4,    4,    5,    5,    7,    4,    4,    5,    3,    5,    4,    4,    3,    3,    3,    3,    2],
    'UNITED KINGDOM': [1,   2,    2,    3,    4,    6,    10,    12,   11,   10,   7,    6,    5,    4,    3,    2,    2,    2,    2],
    'SPAIN':          [3,   2,    3,    3,    4,    4,    6,    2,    2,    2,    1,    1,    1,    1,    1,    1,    1,    1,    1],
    'ITALY':          [4,   4,    5,    6,    6,    6,    6,    3,    3,    3,    3,    2,    2,    2,    2,    2,    2,    1,    1],
    'GERMANY':        [2,   2,    3,    3,    4,    4,    7,    7,    8,    11,   8,    4,    4,    4,    4,    4,    4,    3,    3],
    'RUSSIA':         [3,   3,    2,    2,    2,    2,    2,    6,    8,    9,    7,    4,    4,    4,    4,    4,    3,    3,    3],
    'JAPAN':          [1,   2,    3,    4,    5,    6,    5,    2,    4,    4,    5,    3,    4,    6,    7,    8,    8,    7,    6],
    'INDIA':          [40,  37,   32,   28,   28,   18,   16,   16,   14,   12,   12,   7,    6,    6,    5,    6,    6,    7,    8],
    'CHINA':          [30,  33,   34,   37,   32,   40,   30,   24,   16,   15,   14,   8,    8,    7,    7,    7,    11,  17,    18],
    'UNITED STATES':  [1,   1,    1,    1,    1,    1,    4,    9,    18,   20,   28,   40,   39,   36,   35,   33,   31,   25,   22]
}
# fmt: on
