...
for company in ['OpenAI', 'Anthropic', 'Perplexity', 'xAI (Grok)', 'DeepSeek']:
    ...
    plt.plot(subset['Year'], subset[company], marker='o', label=company, linewidth=2.5, color=colors[company])
...
plt.title('Estimated Revenue Growth of Major AI Companies (2021 - 2025)', fontsize=18, pad=20, fontweight='bold')
...
# Contextual Note
plt.figtext(0.5, 0.01, "Note: Values for 2024/2025 are estimates/run-rate projections. Logarithmic scale used for visual clarity.", 
