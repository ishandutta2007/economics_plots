...
ax1.set_title(
    "India's Annual MBBS Intake Capacity",
    fontsize=13,
    fontweight="bold",
    color=color_intake,
    pad=15,
...
for x, y in zip(years, intake_capacity):
    ax1.annotate(
        ...
        color=color_intake,
        bbox=dict(
            boxstyle="round,pad=0.2", fc="#edf8ff", alpha=0.8, ec=color_intake, lw=0.5
        ),
    )
...
ax2.set_title(
    "India's Total Population Growth Curve",
    fontsize=13,
    fontweight="bold",
    color=color_pop,
    pad=15,
...
for x, y in zip(years, population_billions):
    ax2.annotate(
        ...
        color=color_pop,
        bbox=dict(
            boxstyle="round,pad=0.2", fc="#fff5f5", alpha=0.8, ec=color_pop, lw=0.5
        ),
    )
...
# =========================================================================
plt.suptitle(
    "Side-by-Side Divergence Analysis: Medical Infrastructure vs. Population (1996–2026)",
    fontsize=15,
    fontweight="bold",
    y=0.98,
)
