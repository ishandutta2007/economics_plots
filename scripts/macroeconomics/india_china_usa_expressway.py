...
# Plot curves
plt.plot(
    list(data_india.keys()),
    list(data_india.values()),
    marker="o",
    color="#FF9933",
    linewidth=2.5,
    label="India (Access-Controlled Expressways)",
)
plt.plot(
    list(data_usa.keys()),
    list(data_usa.values()),
    marker="s",
    color="#002868",
    linewidth=2.5,
    label="USA (Interstate Highway System)",
)
plt.plot(
    list(data_china.keys()),
    list(data_china.values()),
    marker="^",
    color="#DE2910",
    linewidth=2.5,
    label="China (National Expressway System)",
)
...
plt.text(
    1955,
    82000,
    "US Interstate Benchmark (~78k km)",
    fontsize=9,
    fontstyle="italic",
    color="gray",
)
...
# Formatting axes
plt.title(
    "Expressway Network Expansion: India vs. USA vs. China\n",
    fontsize=14,
    pad=15,
    fontweight="bold",
)
