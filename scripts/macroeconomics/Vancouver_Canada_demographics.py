...
plt.plot(years, chinese_share, marker='o', color='#d62728', linewidth=2.5, label='Chinese Population Share')
plt.plot(years, south_asian_share, marker='s', color='#ff7f0e', linewidth=2.5, label='South Asian / Indian Subcontinent')

# Customizing plot visuals
plt.title('Demographic Growth Trends in Metro Vancouver (2001–2021)', fontsize=14, fontweight='bold', pad=15)
