...
# Title and Labels
ax.set_title("India's GDP Per Capita Rank Through History", fontsize=16, fontweight='bold', pad=45)
...
ax.text(0.5, 1.02, "Illustrative milestones showing India's relative economic position", 
...
plt.figtext(0.99, 0.01, "Source: Illustrative Historical Milestones", 
