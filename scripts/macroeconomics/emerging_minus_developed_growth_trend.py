...
premium = np.array([
    1.5, 3.2, 1.5, 1.5, 1.9, 1.4, 0.0, -0.1, 1.9, 2.7, 3.2, 4.1,
    4.3, 4.4, 5.1, 5.9, 5.6, 6.2, 4.3, 4.6, 4.2, 3.7, 2.6, 1.9,
    2.7, 2.3, 2.3, 1.9, 2.4, 1.3, 1.5, 2.8, 2.5, 2.5, 2.1
])

# 2. Initialize the plot layout
plt.figure(figsize=(16, 9))
plt.plot(years, premium, marker='o', color='#3b82f6', linewidth=2, 
         label='Annual Growth Premium (EM - DM)', alpha=0.8)
...
plt.plot(smooth_years, trend_function(smooth_years), color='#ef4444', 
         linestyle='--', linewidth=2.5, label='Long-term Smoothed Trend')
...
plt.title("Emerging Markets vs Developed Markets Real GDP Growth Premium (1992–2026)", 
...
plt.axhline(0, color='black', linewidth=0.8, linestyle='-', alpha=0.5) # Zero line reference
