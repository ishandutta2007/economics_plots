...
plt.plot(
    ...
    seats_eng,
    marker="o",
    label="Engineering Intake (Actual)",
    color="#4cabb1",
    linewidth=2.5,
...
plt.plot(
    ...
    projected_seats_eng,
    linestyle="--",
    label="Engineering Intake (Projected)",
    color="#4cabb1",
    linewidth=2.5,
)
plt.plot(
    ...
    projected_seats_med,
    linestyle="--",
    label="Medical Intake (Projected)",
    color="#d62728",
    linewidth=2.5,
)
...
for i, txt in enumerate(seats_med):
    plt.annotate(
        f"{txt:.3f}",
        (medical_years_str[i], seats_med[i]),
        textcoords="offset points",
        xytext=(0, 10),
        ha="center",
        fontsize=9,
...
plt.annotate(
    f"{projected_seats_eng[-1]:.2f}L",
    (projected_years_str[-1], projected_seats_eng[-1]),
    textcoords="offset points",
    xytext=(0, 10),
    ha="center",
    fontsize=10,
...
plt.annotate(
    f"{projected_seats_med[-1]:.2f}L",
    (projected_years_str[-1], projected_seats_med[-1]),
    textcoords="offset points",
    xytext=(0, -20),
    ha="center",
    fontsize=10,
...
# --- Styling ---
plt.title(
    "Engineering vs Medical Seats in India (with Projections to 2047)",
    fontsize=16,
    fontweight="bold",
    pad=20,
)
