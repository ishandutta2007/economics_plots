...
imo_data = [
    (1989, 25, 50), (1990, 17, 54), (1991, 10, 56), (1992, 21, 56), (1993, 15, 73),
    (1994, 16, 69), (1995, 24, 73), (1996, 14, 75), (1997, 21, 82), (1998, 7, 76),
    (1999, 18, 81), (2000, 14, 82), (2001, 7, 83),  (2002, 9, 84),  (2003, 15, 82),
    (2004, 14, 85), (2005, 36, 91), (2006, 35, 90), (2007, 25, 93), (2008, 31, 97),
    (2009, 28, 104), (2010, 36, 95), (2011, 23, 101), (2012, 11, 100), (2013, 29, 97),
    (2014, 39, 101), (2015, 37, 104), (2016, 34, 109), (2017, 52, 111), (2018, 28, 107),
    (2019, 15, 112), (2021, 26, 107), (2022, 24, 104), (2023, 9, 112), (2024, 4, 108),
    (2025, 7, 115), (2026, 7, 117)
]
...
plt.plot(df['Year'], df['Percentile'], marker='o', linestyle='-', color='#2c3e50', 
         linewidth=2, markersize=5, alpha=0.8, label="India's Performance Percentile")
...
plt.scatter(top_milestones['Year'], top_milestones['Percentile'], color='#e74c3c', s=120, zorder=5, label="Top 10 Finishes")
...
plt.annotate(
    ...
    arrowprops=dict(facecolor='#e74c3c', arrowstyle="->", connectionstyle="arc3,rad=-0.1"),
    fontsize=11, fontweight='bold', color='#e74c3c', ha='center'
)

# Plot customization
plt.title("India's IMO Performance Percentile (1989-2026)\nRelative Positioning to Overall Pool Size", fontsize=16, fontweight='bold', pad=15)
...
plt.text(2020, 55, "2020\nNo Participation", color='#7f8c8d', fontsize=9, ha='center', fontweight='bold')
