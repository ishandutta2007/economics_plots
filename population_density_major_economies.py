...
g20_data = {
    'Country': [
        ...
        'South Africa', 'South Korea', 'Turkey', 'United Kingdom', 'United States', 'Netherlands'
    ],
    'Population': [
        47070000, 27880000, 212000000, 41000000, 1425000000, 68600000, 84000000,
        1442000000, 282000000, 59000000, 124520000, 129740000, 144000000, 34570000,
        63210000, 51710000, 85330000, 68000000, 335000000, 17900000
    ],
    'Area_km2': [
        2780085, 7688287, 8515767, 9984670, 9388211, 632702, 357596,
        2973190, 1811570, 301340, 377975, 1960000, 16376870, 2149690,
        1220000, 100339, 783562, 241930, 9147420, 41543 
    ]
}
...
bars = ax.barh(
    df_sorted['Country'],
    df_sorted['Density'],
    color=plt.cm.viridis(df_sorted['Density'] / max(df_sorted['Density'])) # Color gradient
)

# --- Formatting and Styling ---
# Set the title and labels
ax.set_title('Population Density of G20 Countries (>10M Population)', fontsize=18, pad=-10)
